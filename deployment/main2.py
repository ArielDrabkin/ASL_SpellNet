...
json_file = open('model_architecture2.json', 'r')
...
iface = gr.Interface(video_identity,
                     ...
                     examples=[[os.path.join(os.path.dirname(__file__), "MAYA.mp4")],
                               [os.path.join(os.path.dirname(__file__), "phone.mp4")],
                              [os.path.join(os.path.dirname(__file__), "address.mp4")]],
